  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        bodyMMobile: ["18px", { fontWeight: "300", lineHeight: "23px" }],
        headingXL: ["100px", { fontWeight: "300", lineHeight: "100%" }],
        headingXLMobile: ["60px", { fontWeight: "300", lineHeight: "58px" }],
        headingL: ["60px", { lineHeight: "100%", fontWeight: "300" }],
        headingLMobile: ["44px", { lineHeight: "100%", fontWeight: "300" }],
        headingM: ["30px", { lineHeight: "44px" }],
        headingMMobile: ["26px", { lineHeight: "35px", fontWeight: "300" }],
